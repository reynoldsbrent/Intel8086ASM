...
name "stepper"
#make_bin#
steps_before_direction_change = 10h ; 16 (decimal)  - changed from 32
jmp start
; ========= data ===============
; bin data for clock-wise
; full-step rotation: - changed from half-step to full-step
datcw    db 0000_0001b
         db 0000_0011b    
         db 0000_0110b
         db 0000_0000b
...
datccw   db 0000_0100b
         ...
         db 0000_0000b
start:
mov bx, offset datcw ; start from clock-wise full-step. - changed from half-step to full-step
mov si, 0
...
jbe next_step
mov bx, offset datcw ; return to clock-wise full-step.
jmp next_step